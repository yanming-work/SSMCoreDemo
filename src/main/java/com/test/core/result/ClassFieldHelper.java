	...
	public class ClassFieldHelper {  
	    ...
	    */  
	    public static LinkedHashMap<String,LinkedHashMap<String,Object>>   initAnnoFieldDic(@SuppressWarnings("rawtypes") Class clzz){  
	            //用于存储字段和中文值的集合  
	            LinkedHashMap<String,LinkedHashMap<String,Object>>  fieldMap =new LinkedHashMap<String,LinkedHashMap<String,Object>>();  
	            //用于存储实体类字段(key)和中文名(value)  
	            LinkedHashMap<String,Object> descriptionMap = new LinkedHashMap<String,Object>();  
	            LinkedHashMap<String,Object> dbColumnNameMap = new LinkedHashMap<String,Object>();  
	           //获取对象中所有的Field  
